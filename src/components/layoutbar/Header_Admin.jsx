...
const HeaderAdmin = () => {
    ...
    const Songitem = ({ data }) => {
        return (
            <NavLink to={`/song/${data.id}`} className="search_item_name">
    ...
    const Album = ({ data }) => {
        return (
            <NavLink to={`/playlist/${data.id}`} className="search_item_album">
                <div className="search_item_album_img">
                    <img src={data.thumb} alt={data.name} />
                </div>
                <div className="search_item_album_main">
                    <p to={`/playlist/${data.id}`} className="search_item_name">
                        {data.name}
                    </p>
                    <p>Album</p>
                </div>
        ...
        return (
            ...
            >
                ...
                <div className="search_item_artists_main">
                    <p className="search_item_name">{data.name}</p>
                    <p>Nghệ sĩ</p>
                </div>
            </NavLink>
        );
    ...
    return (
        <div style={{ backgroundColor: "#eff7ff" }} className="Header">
