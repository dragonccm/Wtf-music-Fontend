...
const LoginPage = () => {
    ...
    const handleLoginGG = (event) => {
        ...
        window.location.href = 'https://zero-streaming-mauritius-lincoln.trycloudflare.com/api/auth/google';
    }
    const handleLoginFb = (event) => {
        event.preventDefault();

        window.location.href = 'https://zero-streaming-mauritius-lincoln.trycloudflare.com/api/facebook';
    }
    return (
