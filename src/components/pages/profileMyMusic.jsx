    ...
    const Likesong = ({ data }) => (
        <div className="history_ctn">
            <Recommended
                datas={data}
                type={
                    type == "mymusic" ? "Bài hát yêu thích" : "Bài hát đã nghe"
                }
                describe={
                    type == "mymusic" ? "Bài hát yêu thích" : "Bài hát đã nghe"
                }
    ...
    const Myplaylist = ({ datas }) => (
        <section className="mylist_page">
            <div className="Recommended_1">
                {type == "mymusic"
                    ? "Playlist-Album yêu thích"
                    : "Playlist-Album đã nghe"}
            </div>
            ...
            <div className="radio-inputs">
                <label>
                    ...
                    <span className="radio-tile ">
                        <span className="radio-icon">Bài hát</span>
                    </span>
                </label>
                <label>
                    <input
                    ...
                    />
                    <span className="radio-tile ">
                        <span className="radio-icon">Playlist</span>
                    </span>
                </label>
            </div>
            {area === "song" ? (
