...
const Rating = () => {
    const Recommendeds = Array.from({ length: 100 }, (_, index) => ({
        ...
        liked_state: false,
        songdata: "https://aac.saavncdn.com/533/a4d723b<FontAwesomeIcon icon={faCaretUp} /> 40 272bd6bbcb4263c61af847a_320.mp4",
        total: "3:00",
        root_album: "Solo"
    }));
    const week_data = [
    ...
    return (
        <section className="rating_main">
            <Recommended datas={Recommendeds} type={"BXH Tháng 1"} describe={'KPOP'} maxItemsToShow="10" />
            ...
            <section className="week_rating">
                <div className="week_card_ctn">
                    ...
                    {week_data.map((data) => (
                        <div className="week_rating_card">
                            <div className="current_rank">
                                <p>{data.top}</p>
                                <div className="up_to"><FontAwesomeIcon icon={faCaretUp} /> {data.upto} </div>
                            </div>
                    ...
                    <a href="/rating" className="show_all">xem tất cả</a>
                </div>
